!> Module consists of the header for the l2p projection method
!! 
...
module ply_l2p_header_module
  ...
  !> Type of the header for the l2p projection, consisting of the 
...
contains
  ...
  !*****************************************************************************!
  subroutine Copy_l2p_header(left,right)
    !---------------------------------------------------------------------------!
    !> fpt to copy to
